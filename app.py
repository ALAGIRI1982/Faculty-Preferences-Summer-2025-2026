...
def generate_pdf(emp_id, name, designation, b1, b2):
    ...
    content.append(Table(info_data))
...
if st.button("🚀 Submit Preferences"):
    ...
    try:
        ...
        font-size:38px;font-weight:900;color:#16a34a;">
